 ...
 * @author Kevin Casas
 */
public class NovedadExamen extends javax.swing.JInternalFrame {

    public NovedadExamen() {
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        if (cbxcolornovedad.getSelectedItem().equals("Seleccione") || cbxtipoexmnovedad.getSelectedItem().equals("Seleccione") || cbxmotivoexam.getSelectedItem().equals("Seleccione") || cbxmotivoexam.getSelectedItem().equals("-") || cbxidennovedad.getSelectedItem().equals("Seleccione") || (txtidennovedad.getText().equals("") || "".equals(txtidennovedad.getText())) || (txtnomnovedad.getText().equals("") || "".equals(txtnomnovedad.getText())) || (txtrazonnovedad.getText().equals("") || "".equals(txtrazonnovedad.getText())) || (txtsolicinovedad.getText().equals("") || "".equals(txtsolicinovedad.getText()))) {
            ...
            try {
                PreparedStatement sql = Conexion.connection.prepareStatement("UPDATE datos_generales_poli "
                        + "SET  nombre = '" + txtnomnovedad.getText() + "', razon_novedad = '" + txtrazonnovedad.getText() + "', cargoactual = '" + txtcargactnove.getText() + "',  areaactual = '" + txtcampactnove.getText() + "', "
                        + "cargoaspira = '" + txtcargoaspnove.getText() + "', areaaspira = '" + txtcampaspnove.getText() + "', solicitador = '" + txtsolicinovedad.getText() + "', ciudadexamen = '" + CreacionExamen.place.getText() + "', "
                        + "tipoexamen = '" + (String) cbxtipoexmnovedad.getSelectedItem() + "', motivoexamen = '" + (String) cbxmotivoexam.getSelectedItem() + "', estadoexamen = 'Novedad' WHERE t_identificacion = '" + (String) cbxidennovedad.getSelectedItem() + "' AND no_id = AND fechacreacion = '" + fechanow + "' ");
