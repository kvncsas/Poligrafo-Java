...
/**
 * The CorrectorOrtografia class will display a prompt over top of a text component when
 ...
 * class construction.
 */
public class CorrectorOrtografia extends JLabel implements FocusListener, DocumentListener {
	...
	public CorrectorOrtografia(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public CorrectorOrtografia(String text, JTextComponent component, Show show) {
